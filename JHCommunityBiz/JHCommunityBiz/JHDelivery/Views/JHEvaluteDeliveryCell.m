...
#import "JHEvaluteDeliveryCell.h"
#import <Masonry.h>
#import "StarView.h"
...
CGFloat JHEvaluteDeliveryCell_evaluate_height;
CGFloat JHEvaluteDeliveryCell_reply_height;
@implementation JHEvaluteDeliveryCell
{
...
+(CGFloat)getHeightWithModel:(JHEvaluteModel *)model{
    ...
    JHEvaluteDeliveryCell_evaluate_height  = size.height;
    ...
    JHEvaluteDeliveryCell_reply_height = size1.height;
    if (model.photoArray.count > 0 && model.reply.length > 0) {
        return 40 + JHEvaluteDeliveryCell_evaluate_height + 15 + (WIDTH - 50)/4 + 30 + JHEvaluteDeliveryCell_reply_height + 65;
    }else if (model.photoArray.count > 0 && model.reply.length == 0){
        return 40 + JHEvaluteDeliveryCell_evaluate_height + 15 + (WIDTH - 50)/4 + 30 + 30;
    }else if (model.photoArray.count == 0 && model.reply.length > 0){
        return 40 + JHEvaluteDeliveryCell_evaluate_height + 30 + JHEvaluteDeliveryCell_reply_height + 75;
    }else{
        return 40 + JHEvaluteDeliveryCell_evaluate_height + 30 + 40;
    }
}
...
//        imageView.frame = FRAME(10, 35+18, 13, 13);
//        imageView.image = [UIImage imageNamed:@"evaluation03"];
//        [bj_view addSubview:imageView];
    ...
    if(label_comeTiem == nil){
        ...
        label_evaluate.frame = FRAME(10, 70, WIDTH - 20, JHEvaluteDeliveryCell_evaluate_height);
...
//    }
    ...
    if(model.photoArray.count > 0){
        ...
        photo1.frame = FRAME(10, 75 +JHEvaluteDeliveryCell_evaluate_height, (WIDTH - 50)/4, (WIDTH - 50)/4);
        ...
        photo2.frame = FRAME(20 + (WIDTH - 50)/4, 75 +JHEvaluteDeliveryCell_evaluate_height, (WIDTH - 50)/4, (WIDTH - 50)/4);
        ...
        photo3.frame = FRAME(30 + (WIDTH - 50)/4*2, 75 +JHEvaluteDeliveryCell_evaluate_height, (WIDTH - 50)/4, (WIDTH - 50)/4);
        ...
        photo4.frame = FRAME(40 + (WIDTH - 50)/4*3, 75 +JHEvaluteDeliveryCell_evaluate_height, (WIDTH - 50)/4,(WIDTH - 50)/4);
    ...
    if(label_evaluateTime == nil){
        ...
        if (model.photoArray.count > 0) {
             label_evaluateTime.frame = FRAME(10, 75 + (WIDTH - 50)/4 + 5+JHEvaluteDeliveryCell_evaluate_height, 150, 20);
        }else{
              label_evaluateTime.frame = FRAME(10, 75+JHEvaluteDeliveryCell_evaluate_height, 150, 20);
        }
    ...
    if (model.reply.length > 0) {
        ...
        if (model.photoArray.count > 0 ) {
            view_replay.frame = FRAME(10, 75 + (WIDTH - 50)/4 + 30+JHEvaluteDeliveryCell_evaluate_height, WIDTH - 20, JHEvaluteDeliveryCell_reply_height + 30);
        }else{
            view_replay.frame = FRAME(10, 100+JHEvaluteDeliveryCell_evaluate_height, WIDTH - 20, JHEvaluteDeliveryCell_reply_height + 30);
        }
    ...
    if (label_reply == nil) {
        ...
        label_reply.frame = FRAME(5, 5, WIDTH - 30, JHEvaluteDeliveryCell_reply_height);
    ...
    if (label_replyTime == nil) {
        ...
        label_replyTime.frame = FRAME(5, JHEvaluteDeliveryCell_reply_height+5, 200, 20);
    ...
    if(replayImageView == nil&&model.reply.length > 0){
        ...
        if (model.photoArray.count > 0) {
            replayImageView.frame = FRAME(20, 75 + (WIDTH - 50)/4 + 22+JHEvaluteDeliveryCell_evaluate_height, 8, 8);

        }else {
            replayImageView.frame = FRAME(20, 92+JHEvaluteDeliveryCell_evaluate_height, 8, 8);
        }
