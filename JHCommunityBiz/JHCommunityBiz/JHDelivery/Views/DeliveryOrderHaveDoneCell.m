...
//
#import "DeliveryOrderHaveDoneCell.h"
#import "NSDateToString.h"
@implementation DeliveryOrderHaveDoneCell
{
...
- (void)setDataModel:(DeliveryOrderCellModel *)dataModel
{
    ...
    _addressLabel.text = [dataModel.addr length] == 0 ? NSLocalizedString(@"自提", nil): [dataModel.addr stringByAppendingString:dataModel.house ?dataModel.house:@""];
    ...
    [_actionBtn setTitleColor:HEX(@"faaf19",1.0) forState:(UIControlStateNormal)];
}
- (void)call
{
