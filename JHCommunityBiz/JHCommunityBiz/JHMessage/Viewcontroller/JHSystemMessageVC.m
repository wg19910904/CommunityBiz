...
#import <MJRefresh.h>
#import "DSToast.h"
@interface JHSystemMessageVC ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation JHSystemMessageVC
...
- (void)viewDidLoad {
    ...
    //这是请求数据的方法
    SHOW_HUD
    [self postHttpWithPage:@"1" withType:@"4"];
}
...
-(void)downRefresh{
    ...
    [self postHttpWithPage:@(num).description withType:@"4"];
}
