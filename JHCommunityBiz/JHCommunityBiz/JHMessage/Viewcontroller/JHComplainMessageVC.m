...
#import <MJRefresh.h>
#import "DSToast.h"
@interface JHComplainMessageVC ()<UITableViewDataSource,UITableViewDelegate>
{
...
@end
@implementation JHComplainMessageVC
...
- (void)viewDidLoad {
    ...
    //这是请求数据的方法
    SHOW_HUD
    [self postHttpWithPage:@"1" withType:@"3"];
}
...
-(void)downRefresh{
    ...
    [self postHttpWithPage:@(num).description withType:@"3"];
}
