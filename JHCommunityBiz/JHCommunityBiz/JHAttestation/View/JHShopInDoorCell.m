...
@implementation JHShopInDoorCell
{
    UILabel * label;
}
-(void)setSelected:(BOOL)selected animated:(BOOL)animated{
    ...
    if (label == nil) {
        ...
        NSString * str = [NSString stringWithFormat:@"%@%@", NSLocalizedString(@"拍摄许可证照", NSStringFromClass([self class])), NSLocalizedString(@"(请保证所拍照中文清晰)", NSStringFromClass([self class]))];
        ...
        self.imageV_example.image = [UIImage imageNamed:@"exapleImage4"];
