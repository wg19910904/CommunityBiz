...
-(void)setYLabels:(NSArray *)yLabels
{
    ...
    for (int i=0; i<5; i++) {
        if ([_showHorizonLine[i] integerValue]>0) {
            ...
            shapeLayer.strokeColor = [UIColor colorWithRed:132.0/255.0 green:156.0/255.0 blue:199.0/255.0 alpha:1.0f].CGColor;
...
-(void)setXLabels:(NSArray *)xLabels
{
    ...
    for (int i=0; i<xLabels.count; i++) {
        ...
        UUChartLabel * label = [[UUChartLabel alloc] initWithFrame:CGRectMake(i * _xLabelWidth+UUYLabelwidth-_xLabelWidth/2.0, self.frame.size.height - UULabelHeight, _xLabelWidth, UULabelHeight)];
