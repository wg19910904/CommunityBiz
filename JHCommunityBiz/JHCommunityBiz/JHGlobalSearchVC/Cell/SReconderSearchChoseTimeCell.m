...
@interface SReconderSearchChoseTimeCell()
{
    UIImageView *arrowImgV;
}
@end
@implementation SReconderSearchChoseTimeCell
...
-(YFTypeBtn *)rightBtn{
    if (!_rightBtn) {
        ...
        [_rightBtn setTitle: NSLocalizedString(@"请选择", NSStringFromClass([self class])) forState:UIControlStateNormal];
