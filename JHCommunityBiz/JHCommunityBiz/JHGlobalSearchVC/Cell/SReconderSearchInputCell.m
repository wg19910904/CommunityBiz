...
@interface SReconderSearchInputCell()
{
    UIButton *searchBtn;
}
@end
@implementation SReconderSearchInputCell
...
-(UITextField *)inputText{
    if (!_inputText) {
        ...
        _inputText.placeholder =  NSLocalizedString(@"单号/手机号/姓名/地址", NSStringFromClass([self class]));
