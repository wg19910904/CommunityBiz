...
#import "DSToast.h"
@interface JHMediumEvaluationVC ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation JHMediumEvaluationVC
...
-(void)postHttpWithPage:(NSString *)page{
    [HttpTool postWithAPI:@"biz/waimai/comment/comment/items" withParams:@{@"page":page,@"type":@"2"} success:^(id json) {
        NSLog(@"%@",json);
