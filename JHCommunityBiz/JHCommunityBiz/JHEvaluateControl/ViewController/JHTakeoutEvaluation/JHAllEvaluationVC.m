...
#import "DSToast.h"
@interface JHAllEvaluationVC ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation JHAllEvaluationVC
...
-(void)postHttpWithPage:(NSString *)page{
    [HttpTool postWithAPI:@"biz/waimai/comment/comment/items" withParams:@{@"page":page} success:^(id json) {
        NSLog(@"%@",json);
