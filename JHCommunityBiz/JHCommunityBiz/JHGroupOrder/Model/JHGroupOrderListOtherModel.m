...
@implementation JHGroupOrderListOtherModel
+(JHGroupOrderListOtherModel *)creatJHGroupOrderListOtherModelWithDictionary:(NSDictionary *)dic{
    return [[JHGroupOrderListOtherModel alloc]initWithDictionary:dic];
}
