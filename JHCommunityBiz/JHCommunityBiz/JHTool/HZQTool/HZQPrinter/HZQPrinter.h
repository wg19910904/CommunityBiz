...
@interface HZQPrinter : NSObject
typedef NS_ENUM(NSInteger, HZQPrinterStyle) {
    HZQPrinterStyleDefault,
    HZQPrinterStyleCustom
};

/** 文字对齐方式 */
typedef NS_ENUM(NSInteger, HZQTextAlignment) {
    HZQTextAlignmentLeft = 0x00,
    HZQTextAlignmentCenter = 0x01,
    HZQTextAlignmentRight = 0x02
};

/** 字号 */
typedef NS_ENUM(NSInteger, HZQFontSize) {
    HZQFontSizeTitleSmalle = 0x00,
    HZQFontSizeTitleMiddle = 0x11,
    HZQFontSizeTitleBig = 0x22
};
