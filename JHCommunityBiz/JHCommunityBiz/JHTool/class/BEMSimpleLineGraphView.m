...
- (void)commonInit {
    ...
    _colorBackgroundPopUplabel = [UIColor colorWithWhite:0.2 alpha:0.2];
...
- (void)drawLine {
    ...
    line.topColor = [UIColor whiteColor];
    line.bottomColor = [UIColor whiteColor];
    ...
    line.color = [UIColor colorWithRed:50/255.0 green:52/255.0 blue:102/255.0 alpha:1];
...
- (void)drawXAxis {
    ...
    if (self.colorBackgroundXaxis == nil) self.backgroundXAxis.backgroundColor = [UIColor whiteColor];
    else self.backgroundXAxis.backgroundColor = [UIColor whiteColor];
...
- (void)drawYAxis {
    ...
    if (self.colorBackgroundYaxis == nil) backgroundYaxis.backgroundColor = [UIColor whiteColor];
    else backgroundYaxis.backgroundColor = [UIColor whiteColor];
    ...
    if (self.autoScaleYAxis) {
        ...
        for (NSNumber *dotValue in dotValues) {
            ...
            labelYAxis.textColor = [UIColor blackColor];
