...
- (NSArray *)_localizedUndoStrings {
    ...
    dispatch_once(&onceToken, ^{
        NSDictionary *dic = @{
            ...
            @"ja" : @[ @"キャンセル", @"やり直す", @"やり直す - 入力", NSLocalizedString(@"取り消す", nil), NSLocalizedString(@"取り消す - 入力", nil) ],
            ...
            @"zh" : @[ NSLocalizedString(@"取消", nil), NSLocalizedString(@"重做", nil), NSLocalizedString(@"重做键入", nil), NSLocalizedString(@"撤销", nil), NSLocalizedString(@"撤销键入", nil) ],
            @"zh_CN" : @[ NSLocalizedString(@"取消", nil), NSLocalizedString(@"重做", nil), NSLocalizedString(@"重做键入", nil), NSLocalizedString(@"撤销", nil), NSLocalizedString(@"撤销键入", nil) ],
            @"zh_HK" : @[ NSLocalizedString(@"取消", nil), NSLocalizedString(@"重做", nil), NSLocalizedString(@"重做輸入", nil), NSLocalizedString(@"還原", nil), NSLocalizedString(@"還原輸入", nil) ],
            @"zh_TW" : @[ NSLocalizedString(@"取消", nil), NSLocalizedString(@"重做", nil), NSLocalizedString(@"重做輸入", nil), NSLocalizedString(@"還原", nil), NSLocalizedString(@"還原輸入", nil) ]
        };
